---
title: Contributing
description: How to contribute to Grade Tracker — branching, commits, PRs, and code style
---
...
See [Getting Started](/grades-tracker/docs/getting-started) for the full installation guide. For contributing specifically:
...
If your change affects user-facing behaviour, update the relevant page(s) in `docs-site/content/docs/`. Documentation uses [Fumadocs](https://fumadocs.vercel.app/) with MDX.
