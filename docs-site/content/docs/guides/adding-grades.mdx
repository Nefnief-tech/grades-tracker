---
title: Adding and Managing Grades
description: A step-by-step walkthrough for tracking your academic performance
---
...
- [Set up cloud sync](/grades-tracker/docs/guides/setting-up-2fa) to access grades on multiple devices.
- [Export your grades](/grades-tracker/docs/api/export) as CSV or PDF.
- [Configure 2FA](/grades-tracker/docs/guides/setting-up-2fa) to secure your cloud account.
