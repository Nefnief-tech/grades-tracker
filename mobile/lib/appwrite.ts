...
// Function to check if Web Crypto API is available and compatible for React Native
const isCryptoAvailable = () => {
  try {
    // In React Native, crypto is available via polyfills or built-in
    return (
    ...
    console.warn("Crypto API not available:", error);
    return false;
  }
};
