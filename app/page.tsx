            ...
            <div className="bg-muted/30 p-2 md:p-3 rounded-md mt-2 text-xs sm:text-sm flex flex-col sm:flex-row items-start gap-2">
              ...
              <div>
                ...
                <p>
                  ...
                  graph goes up for good grades (1) and down for poor grades
                  (6).
                </p>
                <p>
                  <span className="font-medium">Important:</span> At the current
                  moment, you are not able to delete subjects, so name them
                  carefully
                </p>
              </div>
            </div>
