...
import { AlertCircle, Clock, Wand2, X, ImagePlus, Loader2, BookOpen } from "lucide-react";
...
import { EnhancedGeminiService, GeminiModel } from '@/lib/gemini-service-enhanced';
...
export default function CreateFlashcardsPage() {
  ...
  // Generate flashcards from text/image using AI
  const generateFlashcards = async () => {
    ...
    try {
      ...
      toast.toast({
        ...
        description: `Successfully generated ${newCards.length} flashcards`,
      });
      ...
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add flashcards to your deck manually or generate them with AI</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="ai" className="space-y-4">
                ...
                {/* Additional info about generation */}
                <Alert className="bg-secondary border-muted-foreground/25">
                  <BookOpen className="h-4 w-4" />
                  <AlertTitle>About AI Generation</AlertTitle>
                  <AlertDescription className="text-sm">
                    <p>The AI will generate flashcards based on the text and/or image you provide. For best results:</p>
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li>Choose the appropriate subject area to help the AI generate more relevant flashcards</li>
                      <li>Provide clear, well-structured text with important concepts highlighted</li>
                      <li>When using images, ensure they are clear and readable</li>
                      <li>Combining text and images often produces better results</li>
                    </ul>
                  </AlertDescription>
                </Alert>
              </TabsContent>
          ...
          <CardContent className="pt-4">
            {cards.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm mt-1">Add flashcards manually or generate them with AI</p>
              </div>
            ) : (
