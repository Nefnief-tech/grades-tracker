...
import { debugChatSystem, sendTeamMessage, getTeamMessages, testDirectMessage } from '@/lib/teams-simple';
      ...
      <Card>
        ...
        <CardContent>
          <ol className="list-decimal list-inside space-y-2 text-sm">
            <li>Enter a team ID from your teams list</li>
            ...
            <li>If tests fail, check if the "chat_messages" collection exists in Appwrite</li>
